...
/* harmony import */ var _marquee_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./marquee.js */ "./src/marquee.js");
/* harmony import */ var _marquee_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_marquee_js__WEBPACK_IMPORTED_MODULE_5__);
...
function sliders() {
  var slicks = jQuery('.slick').not('.slick-initialized');
  var marquees = jQuery('.lg-slider').not('.started');
  ...
  marquees.each(function () {
    ...
    that.marquee({
      duplicated: jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).width() > 768,
      direction: 'left',
      pauseOnHover: false
    });
  });
...
var navButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".menu-trigger");

var init = function init() {
  navButton.on("click", function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).toggleClass("active");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("header .inner").toggleClass("active");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".menu-close").toggleClass("active");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sp-nav").toggleClass("opened");
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sp-nav a").on("click", function () {
    navButton.removeClass("active");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("header .inner").removeClass("active");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".menu-close").removeClass("active");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sp-nav").removeClass("opened");
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".js-close-banner").click(function (e) {
    e.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".footer-anime-wrap").addClass("close");
  });
};
...
function loaderStart() {
  var copy1 = document.getElementsByClassName("pLoad_copy_line")[0];
  var copy2 = document.getElementsByClassName("pLoad_copy_line")[1];
  var copy3 = document.getElementsByClassName("pLoad_copy_line")[2];
  gsap__WEBPACK_IMPORTED_MODULE_2__["default"].fromTo(copy1, {
    x: -100
  }, {
    x: 0,
    duration: 3,
    onStart: function onStart() {
      gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(copy1.getElementsByClassName("jsLoad_item"), {
        x: 0,
        duration: 3
      });
      gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(copy1.getElementsByClassName("jsLoad_item_inner"), {
        x: 0,
        duration: 3
      });
    }
  });
  gsap__WEBPACK_IMPORTED_MODULE_2__["default"].fromTo(copy2, {
    x: -100
  }, {
    x: 0,
    duration: 3,
    delay: 0.5,
    onStart: function onStart() {
      gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(copy2.getElementsByClassName("jsLoad_item"), {
        x: 0,
        duration: 3
      });
      gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(copy2.getElementsByClassName("jsLoad_item_inner"), {
        x: 0,
        duration: 3
      });
    }
  });
  gsap__WEBPACK_IMPORTED_MODULE_2__["default"].fromTo(copy3, {
    x: -100
  }, {
    x: 0,
    duration: 3,
    delay: 0.7,
    onStart: function onStart() {
      gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(copy3.getElementsByClassName("jsLoad_item"), {
        x: 0,
        duration: 3
      });
      gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(copy3.getElementsByClassName("jsLoad_item_inner"), {
        x: 0,
        duration: 3
      });
    },
  ...
  gsap__WEBPACK_IMPORTED_MODULE_2__["default"].fromTo(document.getElementsByClassName("jsLoad_logo"), {
    x: -100
  }, {
    x: 0,
    duration: 3,
    delay: 1,
    onStart: function onStart() {
      gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(document.getElementsByClassName("jsLoad_logo_inner"), {
        x: 0,
        duration: 3
      });
      gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(document.getElementsByClassName("jsLoad_logo_cover"), {
        x: 0,
        duration: 3
      });
    }
...
function imagesLoad(container, callback) {
  images = new imagesLoaded__WEBPACK_IMPORTED_MODULE_6___default.a(container, sliders);
...
function initImages(container) {
  ...
  images.on('done', function () {
    gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(document.getElementsByClassName("jsLoad_progress_item"), {
      x: 0,
      duration: 2
    });
    gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(document.getElementsByClassName("jsLoad_progress_item_inner"), {
      x: 0,
      duration: 2,
      onComplete: function onComplete() {
        finishedLoading();
...
function finishedLoading() {
  gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(document.getElementsByClassName("jsLoad_inner_cover"), {
    scaleX: 1,
    scaleY: 1,
    duration: 1,
    delay: 0.6
  });
  gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(document.getElementsByClassName("jsLoad_container"), {
    x: -100 + '%',
    duration: 1.1,
    delay: 0.7
  });
  gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(document.getElementsByClassName("jsLoad"), {
    x: 100 + '%',
    duration: 1.1,
    delay: 0.7,
    onComplete: function onComplete() {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').addClass('load-complete');
      _barba_core__WEBPACK_IMPORTED_MODULE_1___default.a.init({
        ...
        transitions: [{
          ...
          once: function once(_ref) {
            ...
            gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(next.container, {
              opacity: 1
            });
          },
          ...
          afterEnter: function afterEnter(_ref2) {
            var next = _ref2.next;
            imagesLoad(next.container, smooth(next.container));
          },
          leave: function leave(data) {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').addClass('reloading');
            return gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(data.current.container, {
              opacity: 0
            });
          },
          enter: function enter(data) {
            sliders();
            return gsap__WEBPACK_IMPORTED_MODULE_2__["default"].from(data.next.container, {
              opacity: 0
            });
          }
        }]
      });
      _barba_core__WEBPACK_IMPORTED_MODULE_1___default.a.hooks.beforeLeave(function (data) {
        window.scrollTo(0, 0);
      });

      function smooth(container) {
        scroll = new locomotive_scroll__WEBPACK_IMPORTED_MODULE_3__["default"]({
...
function Cf7Init(container) {
  var loader = jquery__WEBPACK_IMPORTED_MODULE_0___default()(container).find('.ajax-loader');

  if (!loader.length) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('div.wpcf7 > form').each(function () {
...
__webpack_require__(/*! C:\Program Files\Ampps\www\next-house.com\wp-content\themes\next\src\app.js */"./src/app.js");
module.exports = __webpack_require__(/*! C:\Program Files\Ampps\www\next-house.com\wp-content\themes\next\src\app.css */"./src/app.css");
